  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ margin: "0 0 22px", color: "#6B6B6B", fontSize: 13.5 }}>
          {mode === "signin" ? "Sign in to continue your learning." : "Start your AI learning journey."}
        </p>
        ...
        <p style={{ textAlign: "center", marginTop: 18, fontSize: 13, color: "#6B6B6B" }}>
          ...
          <button onClick={() => { setMode(mode === "signin" ? "signup" : "signin"); setError(""); }}
            style={{ border: 0, background: "none", color: "#F68A29", fontWeight: 700, cursor: "pointer", fontSize: 13 }}>
